    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-4">
                {/* Stats Cards */}
                <div ref={statsCardsRef} className="grid auto-rows-min gap-4 md:grid-cols-4">
                    <div className="dashboard-card relative aspect-video overflow-hidden rounded-xl border border-sidebar-border/70 bg-background p-6 dark:border-sidebar-border transition-shadow hover:shadow-lg">
                ...
                <div ref={actionCardsRef} className="grid auto-rows-min gap-4 md:grid-cols-3">
                    <div className="dashboard-card relative overflow-hidden rounded-xl border border-sidebar-border/70 bg-background p-6 dark:border-sidebar-border transition-shadow hover:shadow-lg">
                ...
                {/* Main Dashboard Area */}
                <div ref={mainCardRef} className="dashboard-card relative min-h-[100vh] flex-1 overflow-hidden rounded-xl border border-sidebar-border/70 bg-background p-6 md:min-h-min dark:border-sidebar-border transition-shadow hover:shadow-lg">
