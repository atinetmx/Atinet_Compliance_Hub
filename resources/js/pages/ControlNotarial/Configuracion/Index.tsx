            ...
            <div className="min-h-screen space-y-6 p-6">
                ...
                <div className="grid gap-4 md:grid-cols-3">
                    ...
                    <Link href="/admin/control-notarial/alta-catalogos" prefetch>
                        <div className="group cursor-pointer rounded-xl border border-amber-200 bg-gradient-to-br from-amber-50 to-amber-100 p-8 hover:shadow-lg hover:border-amber-400 dark:border-amber-800 dark:from-amber-950/50 dark:to-amber-900/30 transition-all duration-200">
                            <div className="flex items-center gap-4">
                                <div className="rounded-lg bg-amber-500 p-3 text-white shadow-md group-hover:bg-amber-600 transition-colors">
                                    <Tags className="size-8" />
                                </div>
                                <div>
                                    <h3 className="text-xl font-semibold text-amber-900 dark:text-amber-100 group-hover:text-amber-600 dark:group-hover:text-amber-200">
                                        Alta de Catálogos
                                    </h3>
                    ...
                    <Link href="/admin/control-notarial/reporte-usuarios" prefetch>
                        <div className="group cursor-pointer rounded-xl border border-rose-200 bg-gradient-to-br from-rose-50 to-rose-100 p-8 hover:shadow-lg hover:border-rose-400 dark:border-rose-800 dark:from-rose-950/50 dark:to-rose-900/30 transition-all duration-200">
                            <div className="flex items-center gap-4">
                                <div className="rounded-lg bg-rose-500 p-3 text-white shadow-md group-hover:bg-rose-600 transition-colors">
                                    <BarChart3 className="size-8" />
                                </div>
                                <div>
                                    <h3 className="text-xl font-semibold text-rose-900 dark:text-rose-100 group-hover:text-rose-600 dark:group-hover:text-rose-200">
                                        Reporte de Usuarios
                                    </h3>
