...
export default function ControlNotarialConfiguracionIndex() {
    ...
    useEffect(() => {
        const fetchConfiguracionNotaria = async () => {
            try {
                setIsLoading(true);
                const response = await fetch('https://lauran-parthenocarpic-albertina.ngrok-free.dev/api/ConfiguracionNotarial/GetConfiguracionNotaria', {
                    method: 'GET',
                    headers: {
    ...
    useEffect(() => {
        const fetchConfiguracionControl = async () => {
            try {
                const response = await fetch('https://lauran-parthenocarpic-albertina.ngrok-free.dev/api/ConfiguracionNotarial/GetConfiguracionControlNotarial', {
                    method: 'GET',
                    headers: {
                        'Content-Type': 'application/json',
                    },
    ...
    const handleSave = async () => {
        try {
            ...
            const response = await fetch('https://lauran-parthenocarpic-albertina.ngrok-free.dev/api/ConfiguracionNotarial/UpdateConfiguracionNotaria', {
                method: 'PUT',
                body: formData,
            ...
            if (controlConfigId) {
                ...
                const controlResponse = await fetch('https://lauran-parthenocarpic-albertina.ngrok-free.dev/api/ConfiguracionNotarial/UpdateConfiguracionControlNotarial', {
                    method: 'PUT',
                    headers: {
                        'Content-Type': 'application/json',
                    },
