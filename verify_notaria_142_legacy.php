...
echo "=======================================================================\n";
echo "    VERIFICACION NOTARIA 142 EN BASES DE DATOS LEGACY\n";
echo "=======================================================================\n\n";
...
try {
    ...
    if ($busquedasApp->count() > 0) {
        ...
        echo "      ❌ No se encontraron búsquedas de la notaría 142\n";
    }
    ...
    if ($busquedasEscritorio->count() > 0) {
        ...
        echo "      ❌ No se encontraron búsquedas de escritorio de la notaría 142\n";
    }
...
try {
    ...
    if ($consultasSat->count() > 0) {
        ...
        echo "   ❌ No se encontraron consultas SAT de la notaría 142\n";
    }
...
try {
    ...
    if ($consultasOfac->count() > 0) {
        ...
        echo "   ❌ No se encontraron consultas OFAC de la notaría 142\n";
    }
...
echo "  " . str_repeat('-', 60) . "\n";
echo "  🎯 TOTAL BÚSQUEDAS NOTARÍA 142:                    {$granTotal}\n";
echo "\n";

if ($granTotal > 0) {
    echo "✅ La notaría 142 SÍ tiene búsquedas registradas en el sistema legacy\n";
} else {
    echo "❌ La notaría 142 NO tiene búsquedas registradas en ninguna BD legacy\n";
}
